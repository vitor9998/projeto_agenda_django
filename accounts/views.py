...
from django.contrib.auth.decorators import login_required #requer login
...
def dashboard(request):
    ...
    form = FormContato(request.POST, request.FILES) #files ta vindo pq temos um campo de imagem.
